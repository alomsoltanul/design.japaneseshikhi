...
export const TEMPLATE_MAP: Record<string, TemplateDef> = {
  ...
  promo:     { meta: TEMPLATES[5],  defaultData: promoDefaults as Record<string, unknown>,     Poster: PromoPoster,     Controls: PromoCtrl     },
  tip:       { meta: TEMPLATES[6],  defaultData: tipDefaults as Record<string, unknown>,       Poster: TipPoster,       Controls: TipCtrl       },
  announce:  { meta: TEMPLATES[7],  defaultData: announceDefaults as Record<string, unknown>,  Poster: AnnouncePoster,  Controls: AnnounceCtrl  },
  imgbg:     { meta: TEMPLATES[8],  defaultData: imgBGDefaults as Record<string, unknown>,     Poster: ImgBGPoster,     Controls: ImgBGCtrl     },
  imgcard:   { meta: TEMPLATES[9],  defaultData: imgCardDefaults as Record<string, unknown>,   Poster: ImgCardPoster,   Controls: ImgCardCtrl   },
  newstxt:   { meta: TEMPLATES[10], defaultData: newsTxtDefaults as Record<string, unknown>,   Poster: NewsTxtPoster,   Controls: NewsTxtCtrl   },
  newswire:  { meta: TEMPLATES[11], defaultData: newsWireDefaults as Record<string, unknown>,  Poster: NewsWirePoster,  Controls: NewsWireCtrl  },
  newsflash: { meta: TEMPLATES[12], defaultData: newsFlashDefaults as Record<string, unknown>, Poster: NewsFlashPoster, Controls: NewsFlashCtrl },
  newspanel: { meta: TEMPLATES[13], defaultData: newsPanelDefaults as Record<string, unknown>, Poster: NewsPanelPoster, Controls: NewsPanelCtrl },
}
